            ...
            <div className="mt-auto">
                ...
                <div className="px-3 py-3" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                    ...
                    <div className="flex gap-2">
                        <a href="https://wa.me/56974342276" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-1.5 py-2 px-2 rounded-xl bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 hover:text-emerald-300 border border-emerald-500/20 text-xs font-semibold transition-all">
